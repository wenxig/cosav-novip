...
import {
  ...
  MAX_HISTORY,
  SEARCH_HISTORY_KEY,
  API_DEDUPING_INTERVAL,
} from "../data/ParameterDef";
...
function SearchPage() {
  ...
  const { data, error, isLoading } = useSWR(
    `SearchList${queryType}&${queryString}&${currentPage}`,
    fetcher,
    {
      ...
      >
        ...
        {!queryString && (
          <CosAccordion title="如何搜寻？">
            <Typography>搜寻[巨乳+人妻]=显示巨乳且是人妻</Typography>
            <Typography>搜寻[巨乳-人妻]=显示巨乳但不含人妻</Typography>
            <Typography>搜寻[巨乳 人妻]=显示巨乳或人妻</Typography>
          </CosAccordion>
        )}
