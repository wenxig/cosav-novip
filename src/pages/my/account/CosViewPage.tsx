...
import {
  ifAuthFavoriteAlbum,
  ifAuthFavoriteVideo,
} from "../../../Shared/Api/interface/AuthInterface";
    ...
    <BaseMotionDiv>
      ...
      >
        ...
        >
          ...
          <Typography sx={{ color: "red", fontSize: "18px" }}>※记录仅保留30天</Typography>
        </Box>
        ...
        {!error && data && data.videoList && (
          <CosGridFrame items={data.videoList.lists} column={2} />
        )}

        {/* 相簿列表 */}
        {!error && data && data.albumList && (
          <CosGridFrame albums={data.albumList.lists} column={2} />
        )}
