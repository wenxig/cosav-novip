              ...
              <Box key={index}>
                ...
                >
                  <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                    <Typography sx={{ color: "white" }}>{item.CID_name}</Typography>
                    <Typography sx={{ color: cMainColor }}>¥ {item.amount}</Typography>
                  </Box>
                  <Typography
                    sx={{
                ...
                >
                  <Typography sx={{ color: cWhite60 }}>付費方式: {item.pid_name}</Typography>
                  <Typography sx={{ color: cWhite60 }}>{item.ctime}</Typography>
                </Box>
