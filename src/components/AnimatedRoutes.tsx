...
import CosDownloadPage from '../pages/my/account/CosDownloadPage';
import CosDownloadRecordPage from '../pages/my/account/CosDownloadRecordPage';
    ...
    <AnimatePresence mode="popLayout">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/" element={<Layout />}>
          ...
          <Route
            path="categoriesPage/:chid?/:sub_chid?/:page?"
            element={<CategoriesPage />}
          />
          <Route path="videoDetial/:videoId" element={<VideoDetial />} />
          <Route
            path="albumDetial/:albumId/:photoUrl?"
            element={<AlbumDetial />}
          />
          ...
          <Route
            path="my/favorite/:type?/:page?"
            element={<CosFavoritePage />}
          />
          <Route path="my/view/:type?/:page?" element={<CosViewPage />} />
          <Route path="my/account" element={<AccountPage />} />
          <Route path="my/sponsor/:page?" element={<CosSponsorPage />} />
          <Route
            path="my/account/changePassword"
            element={<ChangePasswordPage />}
          />
          <Route path="my/downloads/:page?" element={<CosDownloadPage />} />
          <Route
            path="my/downloadsRecord"
            element={<CosDownloadRecordPage />}
          />
          <Route
            path="search/:type/:queryStr?/:page?"
            element={<SearchPage />}
          />
