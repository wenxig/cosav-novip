    ...
    <>
      ...
      >
        {data?.payment_case?.map((item: any, index: number) => {
          ...
          const borderColor = styleByPayKey.borderColor || item["border-color"] || "#000";
          const backgroundColor =
            styleByPayKey.backgroundGradient || item["background-color"] || "black";
            ...
            >
              ...
              <Button
                ...
                sx={{
                  ...
                  color: "white",
                  "&:hover": {
                    backgroundColor: styleByPayKey.buttonHover || "rgba(71, 71, 71, 1)",
                  },
                }}
