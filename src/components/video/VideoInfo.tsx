...
import { cWhite80, cMainColor } from "../../data/ColorDef";
...
const VideoInfo: React.FC<VideoInfoProps> = ({ video, album }) => {
  ...
  const infoItems = [
    {
      label: "上架日期",
      value: cleanData(video ? video.adddate : album?.adddate),
      searchType: undefined,
    },
    {
      label: "番号",
      value: cleanData(video ? video.barcode : null),
      searchType: "keyword",
    },
    {
      label: "女优",
      value: cleanData(video ? video.author : album?.author),
      searchType: "keyword",
    },
    {
      label: "登场人物",
      value: cleanData(video ? video.cos_role : album?.cos_role),
      searchType: "keyword",
    },
    {
      label: "作品",
      value: cleanData(video ? video.cos_works : album?.cos_works),
      searchType: "keyword",
    },
    {
      label: "片商",
      value: cleanData(video ? video.company : null),
      searchType: "keyword",
    },
    {
      label: "系列",
      value: cleanData(video ? video.series : null),
      searchType: "keyword",
    },
