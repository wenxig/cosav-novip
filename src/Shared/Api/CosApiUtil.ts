...
export class CosApiUtil {
  ...
  private readonly apiCloudServer =
    process.env.REACT_APP_API_CLOUD_SERVER ||
    "https://di4n3-c01.tos-cn-hongkong.bytepluses.com/cossvr2025.txt";
  private readonly defaultApiUrl =
    process.env.REACT_APP_DEFAULT_API_URL || "https://api.cos-dkop.net/api/app/v1";
        ...
        try {
          return {
            ...
            message: jsonData.errorMsg
              ? jsonData.errorMsg.msg.join(",")
              : `API error code with: ${jsonData.code}`,
