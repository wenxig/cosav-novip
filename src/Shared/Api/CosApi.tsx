...
import { ifAuthActivityResponse, ifAuthChangePasswordApiResponse, ifAuthCheckExchangeTicketResponse, ifAuthFavoriteAlbumApiResponse, ifAuthFavoriteVideoApiResponse, ifAuthForgetApiResponse, ifAuthGetExchangeTicketResponse, ifAuthLoginApiResponse, ifAuthRegisterApiResponse, ifAuthSponsorApiResponse, ifAuthUseExchangeTicketResponse } from "./interface/AuthInterface";
...
export const authUseExchangeTicket = async (videoId:string):Promise<ifAuthUseExchangeTicketResponse> => {
    const formData = new FormData();
...
export const checkExchangeTicket = async (videoId:string):Promise<ifAuthCheckExchangeTicketResponse> => {
    const formData = new FormData();
    formData.append("vid",videoId);
